#SOURCE BY : MUZAMIL HUSSAIN 
#TELEGRAM : Muzamil_Hussain_Top
#OWNER OF TOP BANNERS TEAM 🤫 
#!/usr/bin/python3
#-*-coding:utf-8-*-
...
\033[1;93m______________________________________________________
 ...
 \033[1;93m(*)\033[1;92m Developer : ðŸ”¥MUZAMIL HUSSAINðŸ”¥ X ðŸ”¥FAISAL BLOCHðŸ”¥
 \033[1;93m(*)\033[1;92m Tool Type : SIM & CNIC DETAILS \033[1;93m(Only For Pak)
 \033[1;93m(*)\033[1;92m Facebook   : MR.MUZAMIL.HUSSAIN 
 \033[1;93m(*)\033[1;92m Telegram    : https://t.me/topbannermuzamilhussain
\033[1;93m______________________________________________________"""
...
def main():
       ...
       # os.system('xdg-open https://t.me/topbannermuzamilhussain')
        print("")
        ...
        print("\x1b[1;93m[4] \x1b[1;92mJoin on Telegram ")
        ...
        if SYED == '':
                ...
                os.system('xdg-open https://facebook.com/groups/790408624957675/?ref=share_group_link')
                main()
        elif SYED == '3':
                os.system('xdg-open https://chat.whatsapp.com/K1sN9hTQ1lH3tX1PrOWgLJ')
                main()
        elif SYED == '4':
                os.system('xdg-open https://t.me/topbannermuzamilhussain')
                main()
...
def meta_data():
        ...
        if number[0] == str("0"):
                print("")
                print("")
                xox(f"{G}[+] TYPE NUMBER WITHOUT 0 EXAMPLE 3351786195")
                time.sleep(3)
                meta_data()
        done = []
        pk="pak"
